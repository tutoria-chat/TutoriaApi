...
/// All Management API controllers should inherit from this class to access current user information.
/// </summary>
public abstract class BaseAuthController : ControllerBase
{
    ...
    protected User? GetCurrentUserFromClaims()
    {
        ...
        return new User
        {
            ...
            FirstName = User.FindFirst(ClaimTypes.GivenName)?.Value ?? "Unknown",

...
public interface IAssignmentService
{
    ...
    Task<Assignment> CreateAsync(int moduleId, string title, string? description, DateTime dueDate,
        Stream fileStream, string originalFileName, string contentType, long fileSize, User currentUser);
    Task<Assignment> UpdateAsync(int id, string title, string? description, DateTime dueDate, User currentUser);
